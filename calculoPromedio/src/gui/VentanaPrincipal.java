...
public class  VentanaPrincipal<tablaPersona> extends JFrame implements ActionListener{
...
private Object campoDocumento;
private int SwingConstants;
...
lblTitulo.setVerticalAlignment(SwingConstants);
...
lblTotal = new JLabel("");
lblTotal.setVerticalAlignment(SwingConstants);
...
btnCalcular.setBounds(350, 252, 89, 23);
...
private void consultarPersona(Hashtable<String, Persona> tablaPersona) {
	...
	if (tablaPersona.containsKey(documento)== true) {
		...
		mensaje+="Nota1: " + Persona.getNota1()+"\n";
		mensaje+="Nota2: " + Persona.getNota2()+"\n";
		mensaje+="Nota3: " + Persona.getNota3()+"\n";
		mensaje+= "promedio: " + Persona.getPromedio()+"\n";
...
private void registrarpersona(Hashtable<String, Persona> tablaPersona) {
	Persona miPersona=new Persona(); 
		...
		miPersona.setNota1(promedio);
		miPersona.setNota2(promedio);
